...
string CityName[] = {"WareHouse", "Indore", "Bhopal", "Cochin", "Mumbai", "Gwalior", "Delhi", "Ahmedabad", "Sikkim", "Guwahati", "Lucknow"};

string Ahmedabad[]={"Ahmedabad", "Ramol", "CG Road", "Sabarmati", "Bhadra", "Ambli"};

string Indore[]={"Indore", "Vijay Nagar" ,"Scheme-140", "Gumasta Nagar", "Navlakha", "Palasia"};

string Bhopal[]={"Bhopal", "Katara Hills", "Ayodhya Bypass", "Kolar Road", "Shahpura", "Hoshangabad Road"};

string Cochin[]={"Cochin", "Jew Town", "Chottanikkara", "Kakkanad", "Aroor", "Chilavannoor"};

int graph[V][V]={   {0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 3},   //Warehouse
					{4, 0, 0, 0, 0, 0, 0, 6, 0, 0, 2},	 //Indore
					{0, 0, 0, 0, 9, 4, 0, 0, 0, 0, 11},	 //Bhopal
					{0, 0, 0, 0, 1, 0, 0, 0, 16, 5, 0},	 //Cochin
					{0, 0, 9, 1, 0, 8, 13, 0, 10, 6, 0}, //Mumbai	
					{0, 0, 4, 0, 8, 0, 0, 3, 17, 0, 7},	 //Gwalior
					{0, 0, 0, 0, 13, 0, 0, 0, 0, 0, 7},	 //Delhi
					{0, 6, 0, 0, 0, 3, 0, 0, 5, 0, 0},	 //Ahmedabad
					{0, 0, 0, 16, 10, 17, 0, 5, 0, 0, 0},//Sikkim
					{0, 0, 0, 5, 6, 0, 0, 0, 0, 0, 0},	 //Guwahati
...
int AtdGraph[V1][V1]={ 	{ 0, 4, 4, 0, 0, 0 },
						{ 4, 0, 2, 0, 0, 0 },   //Ramol
						{ 4, 2, 0, 3, 2, 4 },	//CG Road
						{ 0, 0, 3, 0, 0, 3 },	//Sabarmati
						{ 0, 0, 2, 0, 0, 3 },	//Bhadra
						{ 0, 0, 4, 3, 3, 0 } };	//Ambli
						
//---------------------Indore------------------------------------
int IsbGraph[V1][V1]={ 	{ 0, 4, 0, 2, 0, 0 },
						{ 4, 0, 3, 1, 0, 6 },	//Vijay Nagar
						{ 0, 3, 0, 4, 0, 7 },	//Scheme-140
						{ 2, 1, 4, 0, 9, 0 },	//Gumasta Nagar
						{ 0, 0, 0, 9, 0, 5 },	//Navlakha
						{ 0, 6, 7, 0, 5, 0 } };	//Palasia
...
int LhrGraph[V1][V1]={ 	{ 0, 9, 15, 6, 0, 0 },
						...
						{ 6, 0, 8, 0, 11, 0 },
						{ 0, 0, 9, 11, 0, 0 },
						{ 0, 8, 5, 0, 0, 0 } };	//Hoshangabad Road

//----------------------Cochin----------------------------------------
int KarGraph[V1][V1]={ 	{ 0, 6, 3, 0, 0, 1 },
						{ 6, 0, 0, 2, 0, 5 },	//Jew Town
						{ 3, 0, 0, 0, 3, 5 },	//Chottanikkara
						{ 0, 2, 0, 0, 6, 4 },	//Kakkanad
						{ 0, 0, 3, 6, 0, 6 },	//Aroor
						{ 1, 5, 5, 4, 6, 0 } };	//Chilavannoor
...
int isb(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Indore: " << endl;
...
int Lhr(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Bhopal: " << endl;
	
	cout<<"\n---------------------------------";
	cout<<"\n |CITY CODE |        AREA         |";
	cout<<"\n---------------------------------";
    cout<<"\n |     1    |    Katara Hills     |"<<endl;
    cout<<"\n |     2    |    Ayodhya Bypass   |"<<endl;
    cout<<"\n |     3    |    Kolar Road       |"<<endl;
	cout<<"\n |     4    |    Shahpura         |"<<endl;
    cout<<"\n |     5    |    Hoshangabad Road |"<<endl;
    cout<<"---------------------------------\n"<<endl;
...
int Kar(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Cochin: " << endl;
	
	cout<<"\n---------------------------------";
	cout<<"\n |CITY CODE |        AREA         |";
	cout<<"\n---------------------------------";
    cout<<"\n |     1    |    Jew Town         |"<<endl;
    cout<<"\n |     2    |    Chottanikkara    |"<<endl;
    cout<<"\n |     3    |    Kakkanad         |"<<endl;
	cout<<"\n |     4    |    Aroor            |"<<endl;
    cout<<"\n |     5    |    Chilavannoor     |"<<endl;
    cout<<"---------------------------------\n"<<endl;
...
int main()
{
	shop =new Shop;
	shop->name="WareHouse";
	shop->address="Comsats University Indore, Chak Shahzad";
